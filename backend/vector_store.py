...
class VectorStore:
    ...
    def add_course_metadata(self, course: Course):
        ...
        for lesson in course.lessons:
            lessons_metadata.append(
                {"lesson_number": lesson.lesson_number, "lesson_title": lesson.title, "lesson_link": lesson.lesson_link}
            )
    ...
    def add_course_content(self, chunks: list[CourseChunk]):
        ...
        metadatas = [
            {"course_title": chunk.course_title, "lesson_number": chunk.lesson_number, "chunk_index": chunk.chunk_index}
            for chunk in chunks
        ]
